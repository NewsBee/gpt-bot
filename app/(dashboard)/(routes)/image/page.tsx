...
import { amountOptions, formSchema, resolutionOptions } from "../image/constant";
...
const PhotoPage = () => {
  ...
  return ( 
    <div>
      <Heading
        title="Buat Gambar"
        description="Perintahkan model untuk membuat gambar."
        icon={ImageIcon}
                ...
                <FormItem className="col-span-12 lg:col-span-6">
                  <FormControl className="m-0 p-0">
                    <Input
                      ...
                      disabled={isLoading} 
                      placeholder="Ikan lumba-lumba di laut" 
                      {...field}
                    />
                  </FormControl>
                </FormItem>
